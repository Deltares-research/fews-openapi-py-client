...
from ...models.warmstatestimes_document_format import WarmstatestimesDocumentFormat
...
def _get_kwargs(
    *,
    ...
    document_format: Unset | WarmstatestimesDocumentFormat = UNSET,
...
def sync_detailed(
    *,
    ...
    """Get all the available warm state times for the specified module instance ids
     ...
     Get all the available warm state times for the specified module instance ids. The module instance id
    is used to retrieve the current taskrun. Since 2022.02
