...
def _get_kwargs(
    *,
    display_id: Unset | str = UNSET,
    document_format: Unset | DocumentdisplaysDocumentFormat = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        display_id (Union[Unset, str]):
        document_format (Union[Unset, DocumentdisplaysDocumentFormat]):
