...
def sync_detailed(
    *,
    ...
    by passing a layerId.<p>The grid cell is determined by specifying a x and y coordinate and a
    bounding box. Currently only EPSG:3857 is supported for the x,y, and bounding box coordinates. At
    least a layer, startTime, endTime, x,y and bounding box are required. The timeseries/grid endpoint
    is intended to be used together with the Delf-FEWS WMS service. Every layer that is provided by the
    WMS service, can be used with this endpoint. The visibleInTimeSeriesDisplay configuration is
    respected. If set to false (default is true), the timeseries will not be returned.
    ...
    Args:
        ...
        x (str):  Example: 458757.12883912364.
        y (str):  Example: 5811252.569955047.
