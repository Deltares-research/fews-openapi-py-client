...
def _get_kwargs(
    *,
    ...
    time_step_id: Unset | str = UNSET,
    thinning: Unset | str = UNSET,
    export_id_map: Unset | str = UNSET,
    export_unit_conversion_id: Unset | str = UNSET,
    time_zone_name: Unset | str = UNSET,
    time_series_ids: Unset | list[str] = UNSET,
    default_request_parameters_id: Unset | str = UNSET,
    resampling_method: Unset | TimeseriesResamplingMethod = UNSET,
    resampling_time_step_id: Unset | str = UNSET,
    resampling_omit_missing: Unset | TimeseriesResamplingOmitMissing = UNSET,
    download_as_file: Unset | str = UNSET,
    match_as_qualifier_set: Unset | TimeseriesMatchAsQualifierSet = UNSET,
    import_from_external_data_source: Unset | TimeseriesImportFromExternalDataSource = UNSET,
    convert_datum: Unset | TimeseriesConvertDatum = UNSET,
    convert_values_to_enumeration_labels: Unset | TimeseriesConvertValuesToEnumerationLabels = UNSET,
    show_ensemble_member_ids: Unset | TimeseriesShowEnsembleMemberIds = UNSET,
    use_display_units: Unset | TimeseriesUseDisplayUnits = UNSET,
    show_thresholds: Unset | TimeseriesShowThresholds = UNSET,
    omit_missing: Unset | TimeseriesOmitMissing = UNSET,
    omit_empty_time_series: Unset | TimeseriesOmitEmptyTimeSeries = UNSET,
    omit_original_reliable: Unset | TimeseriesOmitOriginalReliable = UNSET,
    omit_original_doubtful: Unset | TimeseriesOmitOriginalDoubtful = UNSET,
    omit_original_unreliable: Unset | TimeseriesOmitOriginalUnreliable = UNSET,
    omit_completed_reliable: Unset | TimeseriesOmitCompletedReliable = UNSET,
    omit_completed_doubtful: Unset | TimeseriesOmitCompletedDoubtful = UNSET,
    omit_completed_unreliable: Unset | TimeseriesOmitCompletedUnreliable = UNSET,
    omit_corrected_reliable: Unset | TimeseriesOmitCorrectedReliable = UNSET,
    omit_corrected_doubtful: Unset | TimeseriesOmitCorrectedDoubtful = UNSET,
    omit_corrected_unreliable: Unset | TimeseriesOmitCorrectedUnreliable = UNSET,
    only_manual_edits: Unset | TimeseriesOnlyManualEdits = UNSET,
    only_headers: Unset | TimeseriesOnlyHeaders = UNSET,
    only_forecasts: Unset | TimeseriesOnlyForecasts = UNSET,
    show_statistics: Unset | TimeseriesShowStatistics = UNSET,
    use_milliseconds: Unset | TimeseriesUseMilliseconds = UNSET,
    show_products: Unset | TimeseriesShowProducts = UNSET,
    time_series_type: Unset | TimeseriesTimeSeriesType = UNSET,
    document_format: Unset | TimeseriesDocumentFormat = UNSET,
    ...
    json_external_forecast_times: Unset | list[str] = UNSET
    ...
    json_time_series_ids: Unset | list[str] = UNSET
    ...
    json_resampling_method: Unset | str = UNSET
    ...
    json_match_as_qualifier_set: Unset | str = UNSET
    ...
    json_convert_values_to_enumeration_labels: Unset | str = UNSET
    ...
    json_omit_original_reliable: Unset | str = UNSET
    ...
    json_omit_original_doubtful: Unset | str = UNSET
    ...
    json_omit_original_unreliable: Unset | str = UNSET
    ...
    json_omit_completed_reliable: Unset | str = UNSET
    ...
    json_omit_completed_doubtful: Unset | str = UNSET
    ...
    json_omit_completed_unreliable: Unset | str = UNSET
    ...
    json_omit_corrected_reliable: Unset | str = UNSET
    ...
    json_omit_corrected_doubtful: Unset | str = UNSET
    ...
    json_omit_corrected_unreliable: Unset | str = UNSET
