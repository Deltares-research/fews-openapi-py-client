...
def sync_detailed(
    *,
    ...
    Args:
        times (Union[Unset, datetime.datetime]): Date-time string that adheres to RFC 3339.
            Example: 2020-03-18T15:00:00Z.
        location_id (Union[Unset, str]):  Example: myLocationId.
        ensemble_id (Union[Unset, str]):  Example: myEnsembleId.
        ensemble_member_id (Union[Unset, str]):  Example: myEnsembleId.
        time_series_id (Union[Unset, str]):
        document_format (Union[Unset, TimeserieshistoryDocumentFormat]):
