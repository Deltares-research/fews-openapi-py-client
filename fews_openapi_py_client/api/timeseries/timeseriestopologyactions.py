...
def _get_kwargs(
    *,
    ...
    use_display_units: Unset | TimeseriestopologyactionsUseDisplayUnits = UNSET,
    convert_datum: Unset | TimeseriestopologyactionsConvertDatum = UNSET,
    document_format: Unset | TimeseriestopologyactionsDocumentFormat = UNSET,
