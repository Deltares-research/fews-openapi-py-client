...
def _get_kwargs(
    *,
    ...
    only_headers: Unset | RatingcurvesOnlyHeaders = UNSET,
    use_display_units: Unset | RatingcurvesUseDisplayUnits = UNSET,
    document_format: Unset | RatingcurvesDocumentFormat = UNSET,
