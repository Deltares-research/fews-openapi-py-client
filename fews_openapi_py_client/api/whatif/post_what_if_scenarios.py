...
def sync_detailed(
    *,
    ...
    Args:
        ...
        single_run_what_if (Union[Unset, PostWhatIfScenariosSingleRunWhatIf]):  Example:
            singleRunWhatIf.
        name (Union[Unset, str]):  Example: myName.
        document_format (Union[Unset, PostWhatIfScenariosDocumentFormat]):
