...
from ...models.archiveareas_document_format import ArchiveareasDocumentFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    document_format: Union[Unset, ArchiveareasDocumentFormat] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        document_format (Union[Unset, ArchiveareasDocumentFormat]):
