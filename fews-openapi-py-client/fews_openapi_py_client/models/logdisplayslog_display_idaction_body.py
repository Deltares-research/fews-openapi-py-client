...
class LogdisplayslogDisplayIdactionBody:
    ...
    """ LogDisplaysAction in JSON format sent in the body of the post request. Json format is:
    https://fewsdocs.deltares.nl/webservices/rest-api/v1/schemas/pirest/pi_rest_logdisplays_action_post.json """
