...
class PostforecasternotesBody:
    forecaster_note: str
    """ JSON payload conform the schema: pi_rest_forecaster_notes_post.json. Forecaster note in JSON format sent in
    the body of the post request. To update an existing forecaster note, the id and taskRunId has to be passed. Json
    format is: https://fewsdocs.deltares.nl/webservices/rest-
