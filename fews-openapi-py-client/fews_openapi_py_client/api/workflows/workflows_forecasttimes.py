...
def _get_kwargs(
    *,
    workflow_id: str,
    time_zero: str,
    forecast_time_count: str | Unset = UNSET,
    document_format: WorkflowsForecasttimesDocumentFormat | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        workflow_id (str):
        time_zero (str):
        forecast_time_count (str | Unset):
        document_format (WorkflowsForecasttimesDocumentFormat | Unset):
