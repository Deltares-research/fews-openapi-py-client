...
from ...models.workflows_document_format import WorkflowsDocumentFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    document_format: Union[Unset, WorkflowsDocumentFormat] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        document_format (Union[Unset, WorkflowsDocumentFormat]):
