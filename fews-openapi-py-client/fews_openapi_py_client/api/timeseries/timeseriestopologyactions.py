...
def _get_kwargs(
    *,
    ...
    use_display_units: Union[Unset, TimeseriestopologyactionsUseDisplayUnits] = UNSET,
    convert_datum: Union[Unset, TimeseriestopologyactionsConvertDatum] = UNSET,
    document_format: Union[Unset, TimeseriestopologyactionsDocumentFormat] = UNSET,
    ...
    *,
    ...
    Args:
        ...
        end_time (Union[Unset, datetime.datetime]): Date-time string that adheres to RFC 3339.
            Example: 2020-03-18T15:00:00Z.
        use_display_units (Union[Unset, TimeseriestopologyactionsUseDisplayUnits]):
        convert_datum (Union[Unset, TimeseriestopologyactionsConvertDatum]):
        document_format (Union[Unset, TimeseriestopologyactionsDocumentFormat]):
