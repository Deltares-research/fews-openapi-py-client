...
from ...models.dynamicreportdisplays_use_last_value import DynamicreportdisplaysUseLastValue
...
def _get_kwargs(
    *,
    ...
    use_last_value: Union[Unset, DynamicreportdisplaysUseLastValue] = UNSET,
...
def sync_detailed(
    *,
    ...
    """Get the rendered HTML for the DYNAMIC report display
    ...
    Args:
        ...
        use_last_value (Union[Unset, DynamicreportdisplaysUseLastValue]):
