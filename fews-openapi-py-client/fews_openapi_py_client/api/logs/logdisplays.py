...
def _get_kwargs(
    *,
    log_display_id: str | Unset = UNSET,
    document_format: LogdisplaysDocumentFormat | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        log_display_id (str | Unset):
        document_format (LogdisplaysDocumentFormat | Unset):
