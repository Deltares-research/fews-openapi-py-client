...
def _get_kwargs(
    *,
    body: RatingcurvesstagetodischargeBody,
    location_id: str,
    use_display_units: Union[Unset, RatingcurvesstagetodischargeUseDisplayUnits] = UNSET,
    document_format: Union[Unset, RatingcurvesstagetodischargeDocumentFormat] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        location_id (str):
        use_display_units (Union[Unset, RatingcurvesstagetodischargeUseDisplayUnits]):
        document_format (Union[Unset, RatingcurvesstagetodischargeDocumentFormat]):
