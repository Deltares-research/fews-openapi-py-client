...
def _get_kwargs(
    *,
    ...
    only_headers: RatingcurvesOnlyHeaders | Unset = UNSET,
    use_display_units: RatingcurvesUseDisplayUnits | Unset = UNSET,
    document_format: RatingcurvesDocumentFormat | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        only_headers (RatingcurvesOnlyHeaders | Unset):
        use_display_units (RatingcurvesUseDisplayUnits | Unset):
        document_format (RatingcurvesDocumentFormat | Unset):
