...
from ...models.archivesources_document_format import ArchivesourcesDocumentFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    document_format: Union[Unset, ArchivesourcesDocumentFormat] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        document_format (Union[Unset, ArchivesourcesDocumentFormat]):
